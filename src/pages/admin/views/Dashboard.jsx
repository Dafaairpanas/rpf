    ...
    <div className="p-4 sm:p-6 lg:p-8 bg-[#F4F2EE] min-h-screen space-y-6 sm:space-y-8 lg:space-y-12">
      ...
      >
        <div className="space-y-2">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black text-[#3C2F26] tracking-tighter">
            Operational Nexus
          </h1>
        ...
        {statsData.map((stat, i) => (
          ...
          >
            ...
            <div className="relative space-y-4">
              ...
              <div>
                <p className="text-xl sm:text-2xl lg:text-3xl font-black text-[#3C2F26] tracking-tighter tabular-nums">
                  {stat.value}
                </p>
                <div className="flex flex-col">
                  ...
                  <span className="text-[8px] font-bold text-gray-400 tracking-wider group-hover:text-[#3C2F26]/60">
                    {stat.sub}
                  </span>
                </div>
              </div>
              ...
              recentProducts.map((p, i) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-bold text-[#3C2F26] truncate">
                      {p.name}
                    </p>
                    <div className="flex items-center gap-3">
                      <span className="text-[10px] font-black text-gray-300 uppercase tracking-widest">
                        {p.master_category?.name || "Standard"}
                      </span>
                      <span className="w-1 h-1 bg-gray-200 rounded-full" />
                      <span className="text-[10px] font-bold text-gray-400">
                        {p.material || "Premium Alloy"}
                      </span>
                    </div>
                  </div>
                  <TrendingUp
          ...
          <div className="space-y-4">
            {recentNews.length === 0 ? (
              ...
              recentNews.map((n, i) => (
                <div
                  key={n.id || i}
                  className="group p-6 bg-gray-50 rounded-[2rem] hover:bg-[#3C2F26] transition-all duration-500 cursor-default"
                >
                  ...
                  <p className="text-lg font-bold text-[#3C2F26] group-hover:text-white transition-colors line-clamp-1">
                    {n.title}
                  </p>
                </div>
              ))
