    ...
    <div className="p-8 bg-[#F4F2EE] min-h-screen pt-[96px]">
      ...
      >
        <form onSubmit={handleSave} className="space-y-6">
          <div>
            <label className="block text-sm font-bold text-gray-500 uppercase mb-2">Category Name *</label>
            <input
              type="text"
              required
              value={formData.name}
          ...
          <div>
            <label className="block text-sm font-bold text-gray-500 uppercase mb-2">Slug (Optional)</label>
            <input
              type="text"
              value={formData.slug}
