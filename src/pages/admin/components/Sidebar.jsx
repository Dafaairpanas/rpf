...
import { Home, Box, Tag, Users, Shield, Award, Heart, Newspaper, Image, MessageSquare, X, Menu } from 'lucide-react';
  ...
  const SidebarContent = () => (
    <>
      ...
      <div className="p-2 overflow-y-auto flex-1 custom-scrollbar">
        {/* Menu Section */}
        <div className="text-xs text-[#A6A099] uppercase mb-1 px-2 mt-2 font-medium tracking-wider">Menu</div>
        ...
        {isSuperAdmin && (
          <>
            <div className="text-xs text-[#A6A099] uppercase mb-1 px-2 mt-6 font-medium tracking-wider">Management</div>
